...
public class XiaoMiLogin {
    ...
    public static String getAccessCode(String account, String password, Map<String, Object> map) {
    ...
    public static Map<String, Object> login(String accessCode, Map<String, Object> map) {
